...
public class Board extends JPanel
{
  ...
  Image pacmanImage = Toolkit.getDefaultToolkit().getImage("pacman_img/pacman.jpg"); 
  Image pacmanUpImage = Toolkit.getDefaultToolkit().getImage("pacman_img/pacmanup.jpg"); 
  Image pacmanDownImage = Toolkit.getDefaultToolkit().getImage("pacman_img/pacmandown.jpg"); 
  Image pacmanLeftImage = Toolkit.getDefaultToolkit().getImage("pacman_img/pacmanleft.jpg"); 
  Image pacmanRightImage = Toolkit.getDefaultToolkit().getImage("pacman_img/pacmanright.jpg"); 
  Image ghost10 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost10.jpg"); 
  Image ghost20 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost20.jpg"); 
  Image ghost30 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost30.jpg"); 
  Image ghost40 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost40.jpg"); 
  Image ghost11 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost11.jpg"); 
  Image ghost21 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost21.jpg"); 
  Image ghost31 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost31.jpg"); 
  Image ghost41 = Toolkit.getDefaultToolkit().getImage("pacman_img/ghost41.jpg"); 
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage("pacman_img/titleScreen.jpg"); 
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage("pacman_img/game_over.jpeg");
